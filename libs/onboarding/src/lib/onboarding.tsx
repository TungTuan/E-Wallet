...
import { templateABC, templateACB } from '@e-wallet/config-step';
...
export function Onboarding() {
  const { activeStep, template, isChooseTemplate, showReview, showSuccess } =
        ...
        <Card sx={{ minWidth: '50%' }}>
          <CardBody>
            <Stack divider={<StackDivider />} spacing="4">
              ...
              <Box>
                <Text textAlign={'center'} fontSize="lg" id={'onboading-title'}>
